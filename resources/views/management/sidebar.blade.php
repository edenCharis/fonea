...
<nav class="mt-2 full-height-nav">
  <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
     <li class="nav-item">
            <a href="/management" class="nav-link enhanced-nav-link">
    ...
    <i class="fas fa-chart-line mr-2"></i>AIDE À LA DÉCISION
</li>

    </li>

    <li class="nav-item">
            <a href="/suivi" class="nav-link enhanced-nav-link">
     ...
     <li class="nav-item">
            <a href="/programme" class="nav-link enhanced-nav-link">
            <i class="nav-icon fas fa-calendar-plus text-danger"></i>
