          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                ...
                <button type="button" class="btn btn-sm btn-info" data-toggle="modal" data-target="#addYearModal">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <td>{{ $d->code}}</td>
                    ...
                    <td> 
                            ...
                            <form action="{{ route('direction.destroy', $d->id) }}" method="POST" onsubmit="return confirm('Etes vous sûr de vouloir supprimer cette ligne ?');">
                @csrf
                @method('DELETE')
