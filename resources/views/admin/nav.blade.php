  ...
  <ul class="navbar-nav">
    ...
    <li class="nav-item d-none d-md-block ml-3">
      <div class="nav-link text-white d-flex align-items-center">
        <i class="fas fa-book text-success mr-1"></i>
        <small class="badge badge-success mr-2"><?php echo $actions ?></small>
        <i class="fas fa-users text-info mr-1"></i>
        <small class="badge badge-info mr-2"><?php echo $users ?></small>
        <i class="fas fa-database text-warning mr-1"></i>
