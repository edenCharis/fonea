...
@endif
 ...
 <div class="modal fade" id="addTrimestreModal" tabindex="-1" aria-labelledby="addTrimestreModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="addTrimestreModalLabel">   <i class="nav-icon fas fa-graduation-cap"></i> Ajouter une qualification  </h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form id="trimestreForm" method="POST" action="{{ route('traitementQualification.store') }}">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        <label for="annee_id" class="form-label">Selectionnez le métier </label>
                        <select id="secteur_id" name="metier_id" class="form-select" required>
