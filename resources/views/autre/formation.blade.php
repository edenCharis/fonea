              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                   ...
                   @foreach ($d->realisationFormation as $tde)
                   <div>{{ $tde->npf }}</div>
                   @endforeach
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="trimestreForm" method="POST" action="{{ route('TDE.store') }}">
                ...
                <div class="mb-3">
                <input type="hidden" id="type" name="type" class="form-control" value="1"  required>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                Détailler l'action de formation  d'une TDE  </h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form id="add1" method="POST" action="{{ route('detailsTDE.store') }}">
                ...
                <div class="mb-3">
                    <input type="hidden" name="formation" value="formation" >
                        <label for="tde_id" class="form-label">Selectionnez l'action de formation TDE </label>
                    ...
                    <label for="npaf" class="form-label">Nombre de  personnes à formées</label>
                        ...
                        <input type="number" min="1" id="npaf" name="npaf" class="form-control" placeholder="" required>
                    </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="add2" method="POST" action="{{ route('realisationTDE.store') }}">
                ...
                <div class="modal-body">
                <div class="mb-3">
                <input type="hidden" name="realisation" value="realisationFormation">
                    ...
                    <div class="mb-3">
                    <label for="npf" class="form-label">Nombre de personnes formées </label>

                        <input type="number" min="1" id="npf" name="npf" class="form-control"  required>
                    </div>
                </div>
                <div class="modal-footer">
