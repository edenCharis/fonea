<nav class="mt-2">
  <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
    ...
    <li class="nav-header text-uppercase" style="color: #6c757d; font-weight: 600; font-size: 0.75rem; letter-spacing: 1px; margin-bottom: 10px;">
      <i class="fas fa-graduation-cap mr-2"></i>Formation & Développement
    </li>
    
    <li class="nav-item">
      <a href="/formationQualifiante" class="nav-link enhanced-nav-link">
        <i class="nav-icon fas fa-graduation-cap text-primary"></i>
        <p  class="text-white">Formation qualifiante
    ...
    <li class="nav-item">
      <a href="/formationContinue" class="nav-link enhanced-nav-link">
        <i class="nav-icon fas fa-chart-line text-success"></i>
        <p  class="text-white">Formation Continue
        
        </p>
      </a>
    </li>
    
    <!-- Section Title - Entrepreneuriat -->
    <li class="nav-header text-uppercase" style="color: #6c757d; font-weight: 600; font-size: 0.75rem; letter-spacing: 1px; margin: 15px 0 10px 0;">
      <i class="fas fa-hard-hat mr-2"></i>Entrepreneuriat
    </li>
    
   
        <li class="nav-item">
          <a href="/tde" class="nav-link enhanced-nav-link">
            <i class="fas fa-lightbulb nav-icon text-info"></i>
            <p  class="text-white">Idées de projets</p>
          </a>
        </li>
        <li class="nav-item">
          <a href="/formation" class="nav-link enhanced-nav-link">
            <i class="fas fa-book nav-icon text-success"></i>
            <p  class="text-white">Formations Entrepeunariales</p>
          </a>
        </li>
        <li class="nav-item">
          <a href="/financement" class="nav-link enhanced-nav-link">
            <i class="fas fa-dollar-sign nav-icon text-warning"></i>
            <p class="txt-sm text-white ">Financement d'affaires</p>
          </a>
        </li>
     
    <!-- Section Title - Développement Professionnel -->
    <li class="nav-header text-uppercase" style="color: #6c757d; font-weight: 600; font-size: 0.75rem; letter-spacing: 1px; margin: 15px 0 10px 0;">
      <i class="fas fa-tools mr-2"></i>Développement Professionnel
    </li>
    
    <li class="nav-item">
      <a href="apprentissage" class="nav-link enhanced-nav-link">
        <i class="nav-icon fas fa-tools text-secondary"></i>
        <p  class="text-white">Apprentissage
    ...
    <li class="nav-item">
      <a href="ped" class="nav-link enhanced-nav-link">
        <i class="nav-icon fas fa-school text-info"></i>
        <p  class="text-white">P.E.D
