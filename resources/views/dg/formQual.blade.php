  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
          <h4 class="text-success">  Statistiques d'employabilité via Formation Qualifiante </h4>
                ...
                <form>
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        <label>Métier</label>
                        <select multiple class="custom-select" name="metiers[]"  >
                        @foreach ($metiers as $a )
                            <option value="{{ $a->id }}">{{ $a->libelle}}</option>
                          @endforeach
                        </select>
                      </div>
                  ...
                  <tbody>
                    @foreach ($data as $d)  
                     <tr>
                       ...
                       <td> {{ $d->qualification->metier->libelle }}</td>
                       <td> {{ $d->qualification->libelle }}</td>
                       <td> {{ $d->total_formation }}</td>
                       <td> {{ $d->total_insertion }}</td>
                       <td> {{ $d->total_decrochage }}</td>
