...
<nav class="mt-2 full-height-nav">
  <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
     <li class="nav-item">
            <a href="/dg" class="nav-link enhanced-nav-link">
    ...
    <li class="nav-header text-uppercase" style="color: #6c757d; font-weight: 600; font-size: 0.75rem; letter-spacing: 1px; margin-bottom: 10px;">
      <i class="fas fa-graduation-cap mr-2"></i>BUDGET & PLANNING
    </li>
    
     <li class="nav-item">
            <a href="/planning" class="nav-link enhanced-nav-link">
     ...
     <li class="nav-item">
           ...
           <li class="nav-header text-uppercase" style="color: #6c757d; font-weight: 600; font-size: 0.75rem; letter-spacing: 1px; margin-bottom: 10px;">
      <i class="fas fa-database mr-2"></i>Données statistiques
    </li>
    
     <li class="nav-item">
            <a href="/validation" class="nav-link enhanced-nav-link">
  ...
  <!--  <li class="nav-item">
    <a href="/rapport" class="nav-link enhanced-nav-link">
