...
<head>
  ...
  <title>FONEA | <?php echo Auth::user()->Direction->code ?> </title>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Activitées</a></li>
              <li class="breadcrumb-item active"><?php Auth::user()->Direction->code ?></li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td>{{ $d->user->lastName." ".$d->user->name}}</td>
                    <td
...
function openDeleteModal(id, activityName) {
  ...
  document.getElementById('deleteForm').action = `{{ route('journal_activite.destroy', '') }}/${id}`;
